...
export interface ApiMagicModelMagicModel extends Schema.CollectionType {
  ...
  info: {
    singularName: 'magic-model';
    pluralName: 'magic-models';
    displayName: 'Magic';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    name: Attribute.String & Attribute.Required & Attribute.Unique;
    slug: Attribute.UID<'api::magic-model.magic-model', 'name'> &
      Attribute.Required;
    model: Attribute.Media & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::magic-model.magic-model',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiMaxModelMaxModel extends Schema.CollectionType {
  collectionName: 'max_models';
  info: {
    singularName: 'max-model';
    pluralName: 'max-models';
    displayName: 'MaquinitasMax';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::max-model.max-model', 'name'> &
      Attribute.Required;
